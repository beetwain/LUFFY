...
- The OpenAI integration is implemented; the Gemini integration remains a placeholder
- FSDP and distributed training features need completion


### 🔴 High Priority TODOs

- **API Integration**: Gemini API implementation and OpenAI logging, batching, and timeout support
...
- **Data Processing**: Optimize batch tensor reshaping and strengthen validation
